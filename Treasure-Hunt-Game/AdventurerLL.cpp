...
Adventurer::Position AdventurerLL::checkForTreasure(const Map& map) const
{
	//Check agonal for any treasure, going to every paralel of it.
	...
	*y = pos.get_col();
	...
	{
		int linie = map.getNumberOfRows() - i - 1;
...
Adventurer::Position AdventurerLL::get_new_position(const Map& map) const
{
